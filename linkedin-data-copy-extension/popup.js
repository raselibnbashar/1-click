...
function getData() {
  ...
  // );
  const fName = document.querySelector('span[data-test-row-lockup-full-name] > div').textContent.trim();
...
const aValue = a.querySelector('span').textContent.trim();
 ...
 const ageValue = Math.min(aValue, bValue);
  ...
  // const age = ageValue || "0"; Your Salary Expectation? Your expected Salary?
